...
jules.formats.unicodeword = function(value) {
	return ivar.regex.unicodeword.test(value);
};

jules.formats.unicodesentence = function(value) {
	return ivar.regex.unicodesentence.test(value);
};
